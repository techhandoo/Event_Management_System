    ...
    <section className="py-24 bg-surface-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative bg-gradient-to-br from-brand-600 via-brand-700 to-violet-700 rounded-2xl p-12 sm:p-16 text-center overflow-hidden"
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                to="/events"
                className="btn bg-white/10 text-white hover:bg-white/20 h-12 px-8 text-base backdrop-blur-sm border border-white/20"
              >
                Browse events
              </Link>
            </div>
