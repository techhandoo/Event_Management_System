...
export default function AboutPage() {
  return (
    <StaticPageLayout>
      ...
      >
        {values.map((v) => (
          <motion.div key={v.title} variants={fadeUp} className="glass-card p-6 group hover:border-brand-500/20 transition-all duration-300">
      ...
      >
        {team.map((t) => (
          <motion.div key={t.name} variants={fadeUp} className="glass-card p-6 text-center group hover:border-brand-500/20 transition-all duration-300">
