  ...
  return (
    <StaticPageLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ delay: 0.2 }} className="glass-card p-6 text-center">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ delay: 0.3 }} className="glass-card p-6 text-center">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ delay: 0.4 }} className="glass-card p-6 text-center">
