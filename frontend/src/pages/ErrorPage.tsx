 ...
 return (
  <div className="relative w-28 h-28 mx-auto">
   <div className="absolute inset-0 flex items-center justify-center">
    <div className="w-20 h-20 rounded-2xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center shadow-lg">
   ...
   <motion.div
    ...
    className="absolute top-0 right-0 w-8 h-8 rounded-lg bg-white/[0.06] border border-white/[0.08] flex items-center justify-center"
   >
   ...
   <motion.div
    ...
    className="absolute bottom-1 left-0 w-7 h-7 rounded-full bg-white/[0.04] border border-white/[0.06]"
   />
  </div>
 );
}
 ...
 return (
  <div className="relative w-28 h-28 mx-auto">
   ...
   <motion.div
    ...
    transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
    className="absolute top-1 right-1 w-8 h-8 rounded-lg bg-white/[0.06] border border-white/[0.08] flex items-center justify-center"
   >
 ...
 return (
  <div className="relative w-28 h-28 mx-auto">
   ...
   <motion.div
    ...
    className="absolute top-2 right-0 w-7 h-7 rounded-lg bg-white/[0.06] border border-white/[0.08] flex items-center justify-center"
   >
