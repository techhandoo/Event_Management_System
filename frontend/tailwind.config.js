  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-dark': 'linear-gradient(135deg, #0b0f19 0%, #111827 50%, #1a2235 100%)',
      ...
      keyframes: {
        ...
        glowPulse: { '0%, 100%': { boxShadow: '0 0 20px -5px rgba(99,102,241,0.3)' }, '50%': { boxShadow: '0 0 40px -10px rgba(99,102,241,0.5)' } },
